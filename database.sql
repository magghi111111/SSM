...
CREATE TABLE `ruoli` (
  ...
  `magazzino` tinyint(1) NOT NULL DEFAULT 0,
  `inserimenti_nuovi` tinyint(1) NOT NULL DEFAULT 0,
  `ordini` tinyint(1) NOT NULL DEFAULT 0,
  `consegne` tinyint(1) NOT NULL DEFAULT 0,
